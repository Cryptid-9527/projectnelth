...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_UPD_ARENA_TEAM_WEEK,
    CHAR_UPD_ARENA_TEAM_RANKS,
    CHAR_UPD_ARENA_TEAM_MEMBER,
    CHAR_REP_CHARACTER_PVP_STATS,
    CHAR_REP_RBG_STATS,
    ...
    CHAR_INS_PVP_DETECTION_DATA,
    CHAR_INS_ARENA_LOG,

    CHAR_DEL_CHAR_KEYSTONES,
    CHAR_INS_CHAR_KEYSTONES,
    CHAR_SEL_CHAR_KEYSTONES,
    CHAR_INS_MYTHIC_HISCORES,

    CHAR_REWARD_ARENA,
    CHAR_ARENA_REWARDS,
    CHAR_CLEAN_ARENA_REWARDS,
    CHAR_CLEAN_ARENA_TITLES,
    CHAR_ARENA_TITLE_DIST,
    CHAR_ARENA_TITLE_CLEAN,
    CHAR_UNCLAIMED_TITLE_CLEAN,
    ...
    CHAR_INS_HISTORY_MAIL,
    CHAR_SEL_HISTORY_MAIL_BY_RECV_GUID,
    CHAR_SEL_HISTORY_MAIL_BY_SEND_GUID,
    CHAR_SEL_HISTORY_MAIL_SPECIFIC_LOG,

    CHAR_INS_HISTORY_TRADE,
    CHAR_SEL_HISTORY_TRADE_BY_RECV_GUID,
    CHAR_SEL_HISTORY_TRADE_BY_SEND_GUID,
    CHAR_SEL_HISTORY_TRADE_SPECIFIC_LOG,

    CHAR_SEL_MACROS_FOR_CHARACTER,
    CHAR_SEL_MACROS_FOR_ACCOUNT,

    //Add to the log
    CHAR_INS_COMPLAINT_LOG,

    CHAR_SEL_COMPLAINT_LOG_SOURCE_GUIDS_BY_TARGET_GUID,     //List all GUIDs and counts that have reported a specific guid, used just before a mass mail notification goes out.

    CHAR_SEL_COMPLAINT_LOG_BY_TARGET_GUID,                  //See all reports against specific guid
    CHAR_SEL_COMPLAINT_LOG_BY_SOURCE_GUID,                  //See all reports from a specific guid
    
    CHAR_SEL_COMPLAINT_LOG_BY_MOST_RECENT,                  //See the most recent reports, untfiltered
    CHAR_SEL_COMPLAINT_LOG_BY_SPECIFIC_TYPE,                //See the most reecent reports, of a specific type
    
    CHAR_SEL_COMPLAINT_LOG_TARGETS_BY_MOST_REPORTED,        //See who's been reported the most
    CHAR_SEL_COMPLAINT_LOG_SOURCES_BY_MOST_REPORTED,        //See who's done the most reporting
    
    CHAR_DEL_COMPLAINT_OLDEST,                              //Delete logs older than 2 weeks
    CHAR_DEL_COMPLAINT_SOURCE,                              //Delete log by a specific source (spam reporter)

    CHAR_SEL_ITEM_INSTANCE_LOOKUP_ALL_OF_PLAYER,
