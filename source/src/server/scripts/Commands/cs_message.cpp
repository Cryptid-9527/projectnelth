...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "ownership",      SEC_CONSOLE,  false,  &HandleChannelSetOwnership,         "" },
        };
        static std::vector<ChatCommand> channelCommandTable =
        {
            { "set",            SEC_CONSOLE,  true,   NULL,                               "", channelSetCommandTable },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "channel",        SEC_CONSOLE,  true,   NULL,                               "", channelCommandTable  },
            { "nameannounce",   SEC_CONSOLE,      true,   &HandleNameAnnounceCommand,         "" },
            { "gmnameannounce", SEC_CONSOLE,      true,   &HandleGMNameAnnounceCommand,       "" },
            { "announce",       SEC_CONSOLE,      true,   &HandleAnnounceCommand,             "" },
            { "gmannounce",     SEC_CONSOLE,      true,   &HandleGMAnnounceCommand,           "" },
            { "notify",         SEC_CONSOLE,      true,   &HandleNotifyCommand,               "" },
            { "gmnotify",       SEC_CONSOLE,      true,   &HandleGMNotifyCommand,             "" },
            { "whispers",       SEC_CONSOLE,      false,  &HandleWhispersCommand,             "" },
        };
        return commandTable;
    }
