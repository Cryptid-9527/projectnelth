...
public:
	...
	std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "global",         SEC_CONSOLE,     true,  &HandleAntiCheatGlobalCommand,         ""},
            { "player",         SEC_CONSOLE,     true,  &HandleAntiCheatPlayerCommand,         ""},
            { "delete",         SEC_CONSOLE,  true,  &HandleAntiCheatDeleteCommand,         ""},
            { "handle",         SEC_CONSOLE,  true,  &HandleAntiCheatHandleCommand,         ""},
            { "jail",           SEC_CONSOLE,     true,  &HandleAnticheatJailCommand,         ""},
            { "warn",           SEC_CONSOLE,     true,  &HandleAnticheatWarnCommand,         ""},
        };

		static std::vector<ChatCommand> commandTable =
        {
            { "anticheat",      SEC_CONSOLE,     true, NULL,                     "",  anticheatCommandTable},
        };
