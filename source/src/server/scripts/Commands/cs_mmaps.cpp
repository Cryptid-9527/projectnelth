...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "path",           SEC_CONSOLE,     false, &HandleMmapPathCommand,            "" },
            { "loc",            SEC_CONSOLE,     false, &HandleMmapLocCommand,             "" },
            { "loadedtiles",    SEC_CONSOLE,     false, &HandleMmapLoadedTilesCommand,     "" },
            { "stats",          SEC_CONSOLE,     false, &HandleMmapStatsCommand,           "" },
            { "testarea",       SEC_CONSOLE,     false, &HandleMmapTestArea,               "" },
        };

        static std::vector<ChatCommand> commandTable =
        {
            { "mmap",           SEC_CONSOLE,     true,  NULL,                 "", mmapCommandTable  },
        };
        return commandTable;
    }
