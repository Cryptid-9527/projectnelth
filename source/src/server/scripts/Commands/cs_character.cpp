...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "load",           SEC_CONSOLE,  true,  &HandlePDumpLoadCommand,                 "" },
            { "write",          SEC_CONSOLE,  true,  &HandlePDumpWriteCommand,                "" },
        };
        static std::vector<ChatCommand> characterDeletedCommandTable =
        {
            { "delete",         SEC_CONSOLE,        true,  &HandleCharacterDeletedDeleteCommand,   "" },
            { "list",           SEC_CONSOLE,  true,  &HandleCharacterDeletedListCommand,     "" },
            { "restore",        SEC_CONSOLE,  true,  &HandleCharacterDeletedRestoreCommand,  "" },
            { "old",            SEC_CONSOLE,        true,  &HandleCharacterDeletedOldCommand,      "" },
        };

        static std::vector<ChatCommand> characterCommandTable =
        {
            { "customize",      SEC_CONSOLE,     true,  &HandleCharacterCustomizeCommand,       "" },
            { "changefaction",  SEC_CONSOLE,     true,  &HandleCharacterChangeFactionCommand,   "" },
            { "changerace",     SEC_CONSOLE,     true,  &HandleCharacterChangeRaceCommand,      "" },
            { "deleted",        SEC_CONSOLE,     true,  NULL,                                   "", characterDeletedCommandTable },
            { "erase",          SEC_CONSOLE,        true,  &HandleCharacterEraseCommand,           "" },
            { "level",          SEC_CONSOLE,  true,  &HandleCharacterLevelCommand,           "" },
            { "rename",         SEC_CONSOLE,     true,  &HandleCharacterRenameCommand,          "" },
            { "reputation",     SEC_CONSOLE,     true,  &HandleCharacterReputationCommand,      "" },
            { "titles",         SEC_CONSOLE,     true,  &HandleCharacterTitlesCommand,          "" },
        };

        static std::vector<ChatCommand> commandTable =
        {
            { "character",      SEC_CONSOLE,     true,  NULL,                                   "", characterCommandTable },
            { "levelup",        SEC_CONSOLE,  false, &HandleLevelUpCommand,                  "" },
            { "pdump",          SEC_CONSOLE,  true,  NULL,                                   "", pdumpCommandTable },
        };
        return commandTable;
    }
