...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "activelist",     SEC_CONSOLE,     true,  &HandleEventActiveListCommand,     "" },
            { "start",          SEC_CONSOLE,     true,  &HandleEventStartCommand,          "" },
            { "stop",           SEC_CONSOLE,     true,  &HandleEventStopCommand,           "" },
            { "",               SEC_CONSOLE,     true,  &HandleEventInfoCommand,           "" },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "event",          SEC_CONSOLE,     false, NULL,                  "", eventCommandTable },
        };
        return commandTable;
    }
