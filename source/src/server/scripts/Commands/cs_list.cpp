...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "creature",       SEC_CONSOLE,  true,  &HandleListCreatureCommand,          "" },
            { "item",           SEC_CONSOLE,  true,  &HandleListItemCommand,              "" },
            { "object",         SEC_CONSOLE,  true,  &HandleListObjectCommand,            "" },
            { "auras",          SEC_CONSOLE,  false, &HandleListAurasCommand,             "" },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "list",          SEC_CONSOLE,   true, NULL,                                 "", listCommandTable },
        };
        return commandTable;
    }
