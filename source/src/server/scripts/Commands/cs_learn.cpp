...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "class",          SEC_CONSOLE,  false, &HandleLearnAllMyClassCommand,       "" },
            { "pettalents",     SEC_CONSOLE,  false, &HandleLearnAllMyPetTalentsCommand,  "" },
            { "spells",         SEC_CONSOLE,  false, &HandleLearnAllMySpellsCommand,      "" },
            { "talents",        SEC_CONSOLE,  false, &HandleLearnAllMyTalentsCommand,     "" },
        };

        static std::vector<ChatCommand> learnAllCommandTable =
        {
            { "my",             SEC_CONSOLE,  false, NULL,                                "",  learnAllMyCommandTable },
            { "gm",             SEC_CONSOLE,     false, &HandleLearnAllGMCommand,            "" },
            { "crafts",         SEC_CONSOLE,     false, &HandleLearnAllCraftsCommand,        "" },
            { "default",        SEC_CONSOLE,      false, &HandleLearnAllDefaultCommand,       "" },
            { "lang",           SEC_CONSOLE,      false, &HandleLearnAllLangCommand,          "" },
            { "recipes",        SEC_CONSOLE,     false, &HandleLearnAllRecipesCommand,       "" },
        };

        static std::vector<ChatCommand> learnCommandTable =
        {
            { "all",            SEC_CONSOLE,  false, NULL,                                "",  learnAllCommandTable },
            { "",               SEC_CONSOLE,  false, &HandleLearnCommand,                 "" },
        };

        static std::vector<ChatCommand> commandTable =
        {
            { "learn",          SEC_CONSOLE,      false, NULL,                                "", learnCommandTable },
            { "unlearn",        SEC_CONSOLE,  false, &HandleUnLearnCommand,               "" },
        };
        return commandTable;
    }
