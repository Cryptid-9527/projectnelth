...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "mask",           SEC_CONSOLE,     false, &HandleTitlesSetMaskCommand,        "" },
        };
        static std::vector<ChatCommand> titlesCommandTable =
        {
            { "add",            SEC_CONSOLE,     false, &HandleTitlesAddCommand,            "" },
            { "current",        SEC_CONSOLE,     false, &HandleTitlesCurrentCommand,        "" },
            { "remove",         SEC_CONSOLE,     false, &HandleTitlesRemoveCommand,         "" },
            { "set",            SEC_CONSOLE,     false, NULL,              "", titlesSetCommandTable },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "titles",         SEC_CONSOLE,     false, NULL,                 "", titlesCommandTable },
        };
        return commandTable;
    }
