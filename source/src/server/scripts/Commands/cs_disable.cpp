...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "spell",                  SEC_CONSOLE,      true,   &HandleRemoveDisableSpellCommand,               "" },
            { "quest",                  SEC_CONSOLE,      true,   &HandleRemoveDisableQuestCommand,               "" },
            { "map",                    SEC_CONSOLE,      true,   &HandleRemoveDisableMapCommand,                 "" },
            { "battleground",           SEC_CONSOLE,      true,   &HandleRemoveDisableBattlegroundCommand,        "" },
            { "achievement_criteria",   SEC_CONSOLE,      true,   &HandleRemoveDisableAchievementCriteriaCommand, "" },
            { "outdoorpvp",             SEC_CONSOLE,      true,   &HandleRemoveDisableOutdoorPvPCommand,          "" },
            { "vmap",                   SEC_CONSOLE,      true,   &HandleRemoveDisableVmapCommand,                "" },
            { "mmap",                   SEC_CONSOLE,      true,   &HandleRemoveDisableMMapCommand,                "" },
        };
        static std::vector<ChatCommand> addDisableCommandTable =
        {
            { "spell",                  SEC_CONSOLE,      true,   &HandleAddDisableSpellCommand,                  "" },
            { "quest",                  SEC_CONSOLE,      true,   &HandleAddDisableQuestCommand,                  "" },
            { "map",                    SEC_CONSOLE,      true,   &HandleAddDisableMapCommand,                    "" },
            { "battleground",           SEC_CONSOLE,      true,   &HandleAddDisableBattlegroundCommand,           "" },
            { "achievement_criteria",   SEC_CONSOLE,      true,   &HandleAddDisableAchievementCriteriaCommand,    "" },
            { "outdoorpvp",             SEC_CONSOLE,      true,   &HandleAddDisableOutdoorPvPCommand,             "" },
            { "vmap",                   SEC_CONSOLE,      true,   &HandleAddDisableVmapCommand,                   "" },
            { "mmap",                   SEC_CONSOLE,      true,   &HandleAddDisableMMapCommand,                   "" },
        };
        static std::vector<ChatCommand> disableCommandTable =
        {
            { "add",                    SEC_CONSOLE,      true,   NULL,                                           "", addDisableCommandTable },
            { "remove",                 SEC_CONSOLE,      true,   NULL,                                           "", removeDisableCommandTable },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "disable",                SEC_CONSOLE,     false,   NULL,                                           "", disableCommandTable },
        };
        return commandTable;
    }
