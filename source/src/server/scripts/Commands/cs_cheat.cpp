...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "god",            SEC_CONSOLE,     false, &HandleGodModeCheatCommand,         "" },
            { "casttime",       SEC_CONSOLE,     false, &HandleCasttimeCheatCommand,        "" },
            { "cooldown",       SEC_CONSOLE,     false, &HandleCoolDownCheatCommand,        "" },
            { "power",          SEC_CONSOLE,     false, &HandlePowerCheatCommand,           "" },
            { "waterwalk",      SEC_CONSOLE,     false, &HandleWaterWalkCheatCommand,       "" },
            { "status",         SEC_CONSOLE,     false, &HandleCheatStatusCommand,          "" },
            { "taxi",           SEC_CONSOLE,     false, &HandleTaxiCheatCommand,            "" },
            { "explore",        SEC_CONSOLE,     false, &HandleExploreCheatCommand,         "" },
        };

        static std::vector<ChatCommand> commandTable =
        {
            { "cheat",          SEC_CONSOLE,     false, NULL,                  "", cheatCommandTable },
        };
        return commandTable;
    }
