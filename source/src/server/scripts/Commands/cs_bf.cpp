...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "start",          SEC_CONSOLE,  false, &HandleBattlefieldStart,            "" },
            { "stop",           SEC_CONSOLE,  false, &HandleBattlefieldEnd,              "" },
            { "switch",         SEC_CONSOLE,  false, &HandleBattlefieldSwitch,           "" },
            { "timer",          SEC_CONSOLE,  false, &HandleBattlefieldTimer,            "" },
            { "enable",         SEC_CONSOLE,  false, &HandleBattlefieldEnable,           "" },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "bf",             SEC_CONSOLE,  false, NULL,            "", battlefieldcommandTable },
        };
        return commandTable;
    }
