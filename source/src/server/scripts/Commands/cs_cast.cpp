...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "back",           SEC_CONSOLE,  false, &HandleCastBackCommand,              "" },
            { "dist",           SEC_CONSOLE,  false, &HandleCastDistCommand,              "" },
            { "self",           SEC_CONSOLE,  false, &HandleCastSelfCommand,              "" },
            { "target",         SEC_CONSOLE,  false, &HandleCastTargetCommad,             "" },
            { "dest",           SEC_CONSOLE,  false, &HandleCastDestCommand,              "" },
            { "",               SEC_CONSOLE,  false, &HandleCastCommand,                  "" },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "cast",           SEC_CONSOLE,  false, NULL,                                "", castCommandTable },
        };
        return commandTable;
    }
