...
enum Datas
{
    ...
    DATA_RAID_NERF                  = 36,
    DATA_RAID_NERF_SPELL,
    DATA_SPINE_IMBALANCE,
    DATA_AFRASABI_DELAYED_PHASING,

    GROUP_ENTRANCE_WYRMREST_ACCORD,
    GROUP_TOWER_WYRMREST_ACCORD,
    GROUP_MORCHOK_GROUND_TRASH,
    GROUP_ZONOZZ_YORS_MOBS,
    GROUP_RAID_TEPORTERS,
};
...
enum GlobalMisc
{
    ...
    RAID_MODE_NORMAL                    = 1,
    RAID_MODE_LFR                       = 2,
    RAID_NERF_INACTIVE                  = 0,
    RAID_NERF_ACTIVE                    = 1,
    RAID_NERF_ACTIVE_2_STACKS,
    RAID_NERF_ACTIVE_3_STACKS,
    RAID_NERF_ACTIVE_4_STACKS,
    RAID_NERF_ACTIVE_5_STACKS,
    RAID_NERF_ACTIVE_6_STACKS,
    RAID_NERF_ACTIVE_7_STACKS,
};
...
enum CreatureIds
{
    ...
    NPC_GEN_TRIGGER_PORTALS     = 144951,
...
Position const skyfirePosition = { 13444.930f, -12133.320f, 145.209f, 0.00f };
