...
enum Creatures
{
    ...
    NPC_SAND_VORTEX                 = 42087,

    BOSS_ANRAPHET                   = 39788,
    NPC_VAULT_TROGG_PILLAGER        = 39804,
    NPC_VAULT_TROGG_BRUTE           = 40251,
    NPC_VAULT_TROGG_ROCKFLINGER     = 40252,
...
enum GameObjects
{
    ...
    GO_LIFT_CONTROLLER              = 207699,
    GO_LIFT_OF_THE_MAKER            = 207547,
};
...
enum lever_info
{
    GOBJ_LEVER_LEFT_NM = 203133,
    GOBJ_LEVER_LEFT_HC = 207218,
    GOBJ_LEVER_RIGHT_NM = 203136,
    GOBJ_LEVER_RIGHT_HC = 207219,

    SPELL_LEVER_LEFT = 76606,
    SPELL_LEVER_RIGHT = 76608,
};
