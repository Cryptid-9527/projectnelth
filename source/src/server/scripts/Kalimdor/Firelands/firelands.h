...
enum GameObjectIds
{
    ...
    GO_CIRCLE_OF_THORNS_PORTAL_1    = 209137,
    GO_CIRCLE_OF_THORNS_PORTAL_2    = 209346,
};
...
enum CreatureIds
{
    ...
    NPC_UNSTABLE_MAGMA_STALKER      = 53435,
    NPC_FLAMEWAKER_ANIMATOR         = 53187,
    NPC_FLAMEWAKER_SUBJIGATOR       = 53188,

    // Bethilac
    BOSS_BETHTILAC                  = 52498,
    NPC_CINDERWEB_SPINNER           = 52524,
    NPC_CINDERWEB_SPINNER_RP        = 53642,
    NPC_MOLTEN_LORD                 = 53115,
    NPC_INFERNO_HAWK                = 53648,
    ...
    /*Pre-Rhyolith Trash*/
    NPC_FIRESTORM_TARGET_TRIGGER    = 35592,
    NPC_FIRESTORM_CASTER_TRIGGER    = 35586,
    NPC_KAR_EVERBURNING             = 53616,
    NPC_UNBOUND_PYRELORD            = 53167,
    NPC_UNSTABLE_PYRELORD           = 53630,
    NPC_KARR_LAVA_SPAWN             = 53622,

    // Misc
    NPC_FIREHAWK_FLYING             = 53102,
...
enum PathIDs
{
    ...
    PATH_UNSTABLE_PYRELORD          = 254067, //karr the everburning DB GUID, but still an open ID
};

enum movementInformTypes
{
    MOVEMENT_INFORM_WAYPOINT_START      = 17,
    MOVEMENT_INFORM_WAYPOINT_REACHED    = 2,
};
enum unbound_pyrelord_waypoints
{
    POSITION_1          = 0,
    POSITION_2,
    POSITION_3,
    POSITION_4,
    PYRELORD_BOTTOM_OF_HILL,
};
