...
{
    /*
    entryorguid IN (44990, 46035)   //Packleader ivar alternate ids available
    */
           NPC_QUESTGIVER_IVAR            = 47006,
           NPC_QUESTGIVER_BELMONT         = 47293,
           NPC_MAGISTRATE_HALEB           = 47862,//ashbury's summons
           NPC_FORSAKEN_TROOPER           = 46054,
