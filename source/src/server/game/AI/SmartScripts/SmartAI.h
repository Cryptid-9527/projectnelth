...
enum SmartCombatMove
{
    SMART_COMBAT_MOVE_NONE  = 0,
    SMART_COMBAT_MOVE_FULL  = 1,
    SMART_COMBAT_MOVE_CAST  = 2,
};
...
class SmartAI : public CreatureAI
{
    public:
        ...
        void SetCombatMove(SmartCombatMove on);
        SmartCombatMove CanCombatMove() { return mCombatMove; }
