...
class UnitAI
{
    ...
    public:
        ...
        virtual bool CanBeSeenBy(Unit* who) { return true; };
        ...
        virtual void SpellDamageTaken(Unit* /*attacker*/, uint32 damage, CleanDamage const* cleanDamage, DamageEffectType damagetype, SpellSchoolMask damageSchoolMask, SpellInfo const* spellProto, bool durabilityLoss, bool splitted) {}
