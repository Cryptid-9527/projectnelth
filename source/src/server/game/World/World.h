...
enum WorldBoolConfigs
{
    ...
    CONFIG_SOLOQ_CAST_DESERTER,
	CONFIG_DUNGEON_CAST_DESERTER,
    ...
    CONFIG_SOLO_QUEUE_DPS_RESTRICTION,
    CONFIG_SOLO_QUEUE_ENABLE_MMR,
    CONFIG_ARENA_DAMPENING_ENABLED,
    ...
    CONFIG_TOURNAMENT_ENABLE,
    CONFIG_TOURNAMENT_SET_2_ENABLE,
    CONFIG_TOURNAMENT_NO_FLY,
    CONFIG_TOURNAMENT_RESS_ON_DEATH,
    CONFIG_GM_REQUIRE_BADGE_FOR_CHAT,
    CONFIG_SPELL_DELAY_ENABLE,
    CONFIG_RATE_ADJUSTMENT_FOR_PLAYER_FLOOD,
    CONFIG_GM_COMMAND_ALL_IN_ONE,
    CONFIG_REALMFIRST_BLOCK_FOR_STAFF,
...
enum WorldIntConfigs
{
    ...
    CONFIG_ARENA_DAMPENING_BRACKETS,
    CONFIG_ARENA_DAMPENING_STARTTIME,
    CONFIG_ARENA_DAMPENING_INTERVAL,
    CONFIG_MAX_WHO,
    ...
    CONFIG_TOURNAMENT_VENDOR,
    CONFIG_CARBON_COPY,
    CONFIG_SPELL_DELAY_SPELLS,
    CONFIG_SPELL_DELAY_SLOWS,
    CONFIG_MORPHER_NPC_COST,
    CONFIG_AUCTION_FLOOD_CONTROL_TYPE,
    CONFIG_AUCTION_FLOOD_CONTROL_VALUE,
    CONFIG_LAYER_CAP,
...
struct AffixDetails
{
    //AffixDetails() : affix_name(""), affix_icon_small(""), affix_icon_large(""), affix_description("") {}
    std::string         affix_name;
    std::string         affix_icon;
    std::string         affix_description;
};
...
class World
{
    public:
        ...
        AccountTypes GetEntranceSecurityLimit() const { return m_entranceSecurityLevel; }
        void SetEntranceSecurityLimit(AccountTypes sec);
        ...
        void SendAntiCheat(WorldSession* s, int32 string_id, ...);
        ...
        void setRealmID(uint32 id) { m_localRealmID = id; };
        uint32 getRealmID() { return uint32(m_localRealmID); };
        ...
        void AcknowledgePlayerComplaintsForBan(uint64 banned_guid, uint64 banning_gm);
        void AcknowledgePlayerComplaintsForBanAccountWide(uint64 banned_account, uint64 banning_gm);
        ...
        typedef std::map<uint32, AffixDetails> AffixDataMap;
        typedef AffixDataMap::iterator AffixDataItr;
        AffixDataMap m_AffixData;
    ...
    private:
        ...
        AccountTypes m_entranceSecurityLevel;
