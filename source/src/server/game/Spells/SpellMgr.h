...
#define SPELL_GROUP_STACK_RULE_MAX 5
...
// Enum with CastTimeIndex and their actual cast time

enum SpellCastTimeIndex
{
    CAST_TIME_0_MS      = 1,
    CAST_TIME_250_MS    = 2,
    CAST_TIME_500_MS    = 3,
    CAST_TIME_1000_MS   = 4,
    CAST_TIME_1500_MS   = 16,
    CAST_TIME_2000_MS   = 5,
    CAST_TIME_2200_MS   = 24,
    CAST_TIME_2300_MS   = 31,
    CAST_TIME_2500_MS   = 19,
    CAST_TIME_2600_MS   = 21,
    CAST_TIME_3000_MS   = 14,
    CAST_TIME_3500_MS   = 22,
    CAST_TIME_4000_MS   = 15,
    CAST_TIME_5000_MS   = 6,
    CAST_TIME_10000_MS  = 7,
    CAST_TIME_20000_MS  = 8,
    CAST_TIME_30000_MS  = 9,
};
