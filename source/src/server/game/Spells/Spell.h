...
class Spell
{
    ...
    public:
        ...
        static uint32 GetCustomDelay(SpellInfo const* _spell);
        ...
        void ExecuteLogEffectInterruptCast(uint8 effIndex, Unit* victim, Spell* inputspell);
        void Execute_PvPAction_kick_DatabaseLog(Unit* Interrupter, Spell* inputspell, Unit* victim);
        ...
        uint8 m_cast_count{ 0 };
        uint32 m_requestedTime{ 0 };
        uint32 m_glyphIndex;
        ...
        int32 GetDelaytime() const { return m_delaytime; }
        bool IsAutoRepeat() const { return m_autoRepeat; }
        void SetAutoRepeat(bool rep) { m_autoRepeat = rep; }
        void ReSetTimer() { m_timer = m_casttime > 0 ? m_casttime : 0; }
        int32 GetCastProgress() { return m_cast_count; }
        float GetCastCompletionPercent();
        float GetCastTimeRemaining(bool force_zero_minimum);
        ...
        bool _redirected;
        bool _isReflected;
        void SetStartCastTime(uint32 StartCastTime) { m_StartCast_time = StartCastTime; }
        uint32 GetStartCastTime() { return m_StartCast_time; }
        uint32 m_StartCast_time = 0;                            // Time the cast was started
        ...
        std::list<TargetInfo> GetTargetInfo() { return m_UniqueTargetInfo; };
        void setIsCriticalStrike(int32 crit) { m_isCriticalStrike = crit; }     // 0 = undecided, 1 = false, 2 = true
        int32 getIsCriticalStrike() { return m_isCriticalStrike; }              // 0 = undecided, 1 = false, 2 = true
        int32 m_isCriticalStrike = 0;                                           // 0 = undecided, 1 = false, 2 = true
    protected:
        ...
        int32 m_delaytime;                                  // amount of time that has been delayed for this spell
