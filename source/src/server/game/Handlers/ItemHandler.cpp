...
void WorldSession::SendItemSparseDb2Reply(uint32 entry)
{
    ...
    switch (proto->ItemId)
    {
    case 100006://Contribution appreciation.
        desc = "Time is the most valuable currency.\n\nGiven by Neltharion development, as a token of appreciation for volunteer contributions too significant to ever fully repay.";
        break;
    case 100050://Mythic Keystone
        desc = "|cff00ff00Use:\n\nOutside mythic challenge:\nReveal the details of your next mythic challenge.\n\nInside mythic challenge:\nReveal a nearby kill credit target.|r";
        break;
    default:
        break;
    }
    ...
    for (uint16 slot = 0; slot < rawItemCount; ++slot)
    {
        ...
        if (vendorItem->Type == ITEM_VENDOR_TYPE_ITEM)
        {
            ...
            if (!_player->isGameMaster()) // ignore conditions if GM on
            {
                ...
                /*
                    Only the highest level poison available to a player should be offered.
                */
                /*
                switch (itemTemplate->ItemId)
                {
                case 21835://68 anesthetic
                    if (_player->getLevel() >= 77)   continue;
                case 43237://77 anesthetic
                    break;

                case 2892://30 deadly
                    if (_player->getLevel() >= 38)   continue;
                case 2893://38 deadly
                    if (_player->getLevel() >= 46)   continue;
                case 8984://46 deadly
                    if (_player->getLevel() >= 54)   continue;
                case 8985://54 deadly
                    if (_player->getLevel() >= 60)   continue;
                case 20844://60 deadly
                    if (_player->getLevel() >= 62)   continue;
                case 22053://62 deadly
                    if (_player->getLevel() >= 70)   continue;
                case 22054://70 deadly
                    if (_player->getLevel() >= 76)   continue;
                case 43232://76 deadly
                    if (_player->getLevel() >= 80)   continue;
                case 43233://80 deadly
                    break;

                case 6947://10 instant
                    if (_player->getLevel() >= 28)   continue;
                case 6949://28 instant
                    if (_player->getLevel() >= 36)   continue;
                case 6950://36 instant
                    if (_player->getLevel() >= 44)   continue;
                case 8926://44 instant
                    if (_player->getLevel() >= 52)   continue;
                case 8927://52 instant
                    if (_player->getLevel() >= 60)   continue;
                case 8928://60 instant
                    if (_player->getLevel() >= 68)   continue;
                case 21927://68 instant
                    if (_player->getLevel() >= 73)   continue;
                case 43230://73 instant
                    if (_player->getLevel() >= 79)   continue;
                case 43231://79 instant
                    break;
                    
                case 3775://20 crippling
                    if (_player->getLevel() >= 50)   continue;
                case 3776:
                    break;

                case 5237://24 mind-numb
                    break;
                case 10918://32 wound
                    if (_player->getLevel() >= 40)   continue;
                case 10920://40 wound
                    if (_player->getLevel() >= 48)   continue;
                case 10921://48 wound
                    if (_player->getLevel() >= 56)   continue;
                case 10922://56 wound
                    if (_player->getLevel() >= 64)   continue;
                case 22055://64 wound
                    if (_player->getLevel() >= 72)   continue;
                case 43234://72 wound
                    if (_player->getLevel() >= 78)   continue;
                case 43235://78 wound
                    break;
