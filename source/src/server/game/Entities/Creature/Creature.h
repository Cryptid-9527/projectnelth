...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | \
    ...
    CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_NO_MOVE_FLAGS_UPDATE)
...
class Creature : public Unit, public GridObject<Creature>, public MapObject
{
    public:
        ...
        bool isTrainingDummy() const { return (GetScriptName() == "npc_training_dummy"); };
        ...
        void ConnectToObjTransport(WorldObject* obj, bool connect = true);
        ...
        void InitializeReactState()
        {
            ...
            if (isTotem() || isTrigger() || isSpiritService())
                SetReactState(REACT_PASSIVE);
            else
                SetReactState(REACT_AGGRESSIVE);
        }

        void SetNPCFollowData(NpcFollowData new_data) { m_followData = new_data; };    //TargetedMovementGenerator decision to recalculate position or not.
        NpcFollowData GetNPCFollowData() { return m_followData; };                     //TargetedMovementGenerator decision to recalculate position or not.
        ...
        bool CanBeSubjectOfAffix(uint32 affix);
        ...
        void AllLootRemovedFromCorpse(bool loot_was_empty = false);
        ...
        bool SkinLooted { false };
        bool GetSkinLooted() { return SkinLooted; }
        void SetSkinLooted(bool looted) { SkinLooted = looted; }
        ...
        uint32 GenerateDynamicRespawn(uint32 base_respawn);
        ...
        {
            if (pos >= MAX_SPELL_CHARM || m_charmInfo->GetCharmSpell(pos)->GetType() != ACTIONBAR_STATE_AURA_ACTIVE_OR_SPELL_AUTOCAST)
                return 0;
            else
    ...
    protected:
        ...
        uint32 m_coldrespawnDelay;                          // secs
