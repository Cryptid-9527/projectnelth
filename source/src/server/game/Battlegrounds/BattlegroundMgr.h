...
class BattlegroundMgr
{
    ...
    public:
        ...
        Battleground* CreateNewBattleground(BattlegroundTypeId bgTypeId, PvPDifficultyEntry const* bracketEntry, uint8 arenaType, bool isRated, BattlegroundTypeId bgTypeIdRandom = BATTLEGROUND_TYPE_NONE, bool isWarGame = false);
