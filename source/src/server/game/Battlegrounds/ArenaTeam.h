...
enum ArenaTeamCommandErrors
{
    ...
    ERR_ARENA_TEAM_LEADER_LEAVE_S           = 0x08, //CORRECT CONFIRMED "You must promote a new team captain using /teamcaptain before leaving the team"
...
{
    //2 IS INTERNAL GUILD ERROR, NEVER CALL IT FFS
    //3 is also internal guild error?
    //INTERNAL_GUILD_ERROR_0                  = 0,            //returns internal guild error with correctly input debug arguements 2/24/2021, cryptid
    //INTERNAL_GUILD_ERROR_1                  = 1,            //returns internal guild error with correctly input debug arguements 2/24/2021, cryptid
    //INTERNAL_GUILD_ERROR_2                  = 2,            //returns internal guild error with correctly input debug arguements 2/24/2021, cryptid
    //INTERNAL_GUILD_ERROR_3                  = 3,            //returns internal guild error with correctly input debug arguements 2/24/2021, cryptid

    ERR_ARENA_TEAM_JOIN_SS = 4,           // player name + arena team name CORRECTED 2/24/2021, cryptid
    ERR_ARENA_TEAM_LEAVE_SS = 5,           // player name + arena team name CORRECTED 2/24/2021, cryptid
    ERR_ARENA_TEAM_REMOVE_SSS = 6,           // captain name, arena team name, member name CORRECTED 2/24/2021, cryptid
    ERR_ARENA_TEAM_LEADER_IS_SS = 7,           // player name + arena team name UNUSED?
    ERR_ARENA_TEAM_LEADER_CHANGED_SSS = 8,            // old captain + new captain + arena team name CORRECTED 2/24/2021, cryptid
    ERR_ARENA_TEAM_DISBANDED_S = 9           // captain name + arena team name CORRECTED 2/24/2021, cryptid

    //INTERNAL_GUILD_ERROR_10                  = 10,            //returns internal guild error with correctly input debug arguements 2/24/2021, cryptid
};
