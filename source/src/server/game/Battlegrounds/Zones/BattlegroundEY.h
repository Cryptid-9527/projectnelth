...
// x, y, z, o
const float BG_EY_TriggerPositions[5][4] =
{
    //|| !AddObject(BG_EY_OBJECT_FLAG_NETHERSTORM, BG_OBJECT_FLAG2_EY_ENTRY,, 0, 0, 0.662620f, -0.748956f, RESPAWN_ONE_DAY)
...
class BattlegroundEY : public Battleground
{
    ...
    private:
        ...
        uint32 ANTICHEAT_time_since_pull;                   ///< Stored timer for how long a flag has been away from it's base, standalone in-script anticheat measure.
        uint64 ANTICHEAT_original_Flag_Puller;
