...
enum BG_EYR_WorldStates
{
    ...
    BG_EYR_OP_OCCUPIED_BASES_HORDE      = 1778,
    BG_EYR_OP_OCCUPIED_BASES_ALLY       = 1779,
    ...
    BG_EYR_NODE_MAGE_TOWER_WS           = 1761, //All of these require values 1 through 5
    BG_EYR_NODE_BLOODELF_TOWER_WS       = 1763,
    BG_EYR_NODE_FELREAVER_RUINS_WS      = 1764,
    BG_EYR_NODE_DRAENEI_RUINS_WS        = 1765,
};
...
const uint32 BG_EYR_FlagPoints[4]        = { 40, 80, 120, 160 };
...
enum BG_EYR_NodeObjectId
{
    ...
    BG_EYR_RBG_OBJECTID_NODE_BANNER_0    = 406009,       // Neutral Banner
};
...
enum BG_EYR_NODE_WORLDSTATES    //ACTUAL CLIENT WORLDSTATES
{
    STATE_HIDDEN            = 0,
    STATE_HORDE_CONTROL     = 1,
    STATE_HORDE_ASSAULT     = 2,
    STATE_NEUTRAL           = 3,
    STATE_ALLIANCE_ASSAULT  = 4,
    STATE_ALLIANCE_CONTROL  = 5,
};

enum BG_EYR_Sounds
{
    BG_EYR_SOUND_NODE_CLAIMED       = 8192,
    BG_EYR_SOUND_ALLIANCE_CAPTURE   = 8173,
    BG_EYR_SOUND_HORDE_CAPTURE      = 8213,
    BG_EYR_SOUND_ASSAULT_ALLIANCE   = 8212,
    BG_EYR_SOUND_ASSAULT_HORDE      = 8174,
    BG_EYR_SOUND_NEAR_VICTORY       = 8456,
    BG_EYR_SOUND_FLAG_RESET         = 8232
};
...
{
    {2043.96f, 1729.93f, 1189.81f, 4.68283f},               // FEL_REAVER center
    {2048.49f, 1393.56f, 1194.28f, 1.66342f},               // BLOOD_ELF center
    {2286.54f, 1402.49f, 1197.02f, 1.53238f},               // DRAENEI_RUINS center
    {2284.73f, 1731.14f, 1189.68f, 4.79066f},               // MAGE_TOWER center
};

const float BG_EYR_TriggerPositions[5][4] =
{
    {2043.9341f, 1729.999f, 1189.96f, 0.017453f},           // FEL_REAVER center
    {2048.4340f, 1393.5200f, 1194.49f, 0.20944f},           // BLOOD_ELF center
    {2286.4705f, 1402.4939f, 1197.11f, 3.72381f},           // DRAENEI_RUINS center
    {2284.7645f, 1731.1902f, 1189.99f, 2.89725f},           // MAGE_TOWER center
    {2174.249756f, 1569.913185f, 1159.740235f, -1.503602f}  // Middle flag
};
...
class BattlegroundEYR : public Battleground
{
    public:
        ...
        uint32 GameStateToWorldState(uint32 GameState);
