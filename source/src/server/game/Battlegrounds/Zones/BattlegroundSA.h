...
enum BG_SA_Sounds
{
    BG_SA_SOUND_NODE_CLAIMED                = 8192,
    BG_SA_SOUND_ALLIANCE_CAPTURE            = 8173,
    BG_SA_SOUND_HORDE_CAPTURE               = 8213,
    BG_SA_SOUND_ASSAULT_ALLIANCE            = 8212,
    BG_SA_SOUND_ASSAULT_HORDE               = 8174,
    BG_SA_SOUND_NEAR_VICTORY                = 8456,
    BG_SA_SOUND_FLAG_RESET                  = 8232
...
enum npc
{
    ...
    NPC_WORLD_FLAGPOLE_TRIGGER      = 12999,
    NPC_TELEPORT_TRIGGER_BLUE       = 23472,
    NPC_TELEPORT_TRIGGER_GREEN      = 23472,
    NPC_TELEPORT_TRIGGER_PURPLE     = 23472,
    NPC_TELEPORT_TRIGGER_GOLD       = 23472,
    NPC_TELEPORT_TRIGGER_RED        = 23472
};
...
enum BG_SA_NPCs
  {
    ...
    BG_SA_GUN_9,
    BG_SA_GUN_10,
    BG_SA_NPC_TRIGGER_BLUE,
    BG_SA_NPC_TRIGGER_GREEN,
    BG_SA_NPC_TRIGGER_PURPLE,
    BG_SA_NPC_TRIGGER_GOLD,
    BG_SA_NPC_TRIGGER_RED,
    BG_SA_DEMOLISHER_1,
    BG_SA_DEMOLISHER_2,
    BG_SA_DEMOLISHER_3,
    BG_SA_DEMOLISHER_4,
    ...
    BG_SA_NPC_RIGSPARK,
    BG_SA_FLAGPOLE_TRIGGER_1,
    BG_SA_FLAGPOLE_TRIGGER_2,
    BG_SA_FLAGPOLE_TRIGGER_3,
    BG_SA_MAXNPC
  };
...
uint32 const BG_SA_NpcEntries[BG_SA_MAXNPC] =
{
    ...
    NPC_ANTI_PERSONNAL_CANNON,
    // Triggers
    NPC_TELEPORT_TRIGGER_BLUE,
    NPC_TELEPORT_TRIGGER_GREEN,
    NPC_TELEPORT_TRIGGER_PURPLE,
    NPC_TELEPORT_TRIGGER_GOLD,
    NPC_TELEPORT_TRIGGER_RED,
    // 4 beach demolishers
    NPC_DEMOLISHER_SA,
    NPC_DEMOLISHER_SA,
    NPC_DEMOLISHER_SA,
    ...
    // Flagpole capturing effect triggers
    NPC_WORLD_FLAGPOLE_TRIGGER,
    NPC_WORLD_FLAGPOLE_TRIGGER,
    NPC_WORLD_FLAGPOLE_TRIGGER
};
...
{
    // Cannons
    { 1436.429f, 110.05f, 41.407f, 5.4f },//0
    { 1404.9023f, 84.758f, 41.183f, 5.46f },//1
    { 1068.693f, -86.951f, 93.81f, 0.02f },//2
    { 1068.83f, -127.56f, 96.45f, 0.0912f },//3
    { 1422.115f, -196.433f, 42.1825f, 1.0222f },//4
    { 1454.887f, -220.454f, 41.956f, 0.9627f },//5
    { 1232.345f, -187.517f, 66.945f, 0.45f },//6
    { 1249.634f, -224.189f, 66.72f, 0.635f },//7
    { 1236.213f, 92.287f, 64.965f, 5.751f },//8
    { 1215.11f, 57.772f, 64.739f, 5.78f },//9
    // Triggers
    ...
    { 1215.114258f, -65.711861f, 71.0f, -3.124123f}, //south flagpole
    {1338.863892f, -153.336533f, 31.5f, -2.530723f}, //east falgpole
    {1309.124268f, 9.410645f, 31.5f, -1.623156f} //west flagpole
};
...
float const BG_SA_ObjSpawnlocs[BG_SA_MAXOBJ][4] =
{
    ...
    // Ships
    { 2684.669922f, -830.478210f, 3.712860f, 5.68367f}, // left boat boat pov
    { 2574.003662f, 981.261475f, 2.603424f, 0.807696f}, // right boat boat pov
    // Sigils
    ...
    // Flagpoles
    {1215.114258f, -65.711861f, 70.084267f, -3.124123f},//south flagpole
    {1338.863892f, -153.336533f, 30.895121f, -2.530723f},//east falgpole
    {1309.124268f, 9.410645f, 30.893402f, -1.623156f},//west flagpole
    // Flags
...
class BattlegroundSA : public Battleground
{
    ...
    private:
        uint8 Sparklight_Yell_status = 0;
        uint16 Sparklight_Yell_counter = 0;

        uint8 Rigspark_Yell_status = 0;
        uint16 Rigspark_Yell_counter = 0;

        uint8 startships_delayed_trigger = 0;
        uint16 startships_delayed = 0;
        uint16 removal_timer_BG_SA_BLUE_GATE = 0;
        uint16 removal_timer_BG_SA_RED_GATE = 0;
        uint16 removal_timer_BG_SA_GREEN_GATE = 0;
        uint16 removal_timer_BG_SA_PURPLE_GATE = 0;
        uint16 removal_timer_BG_SA_YELLOW_GATE = 0;
        /**
        ...
        /**
         * \brief Called on server update event
         * -Correct any improper gate damage
         */
        void Gate_Structure_Anticheat();
        /**
