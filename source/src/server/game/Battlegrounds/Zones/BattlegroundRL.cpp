...
void BattlegroundRL::HandleKillPlayer(Player* player, Player* killer)
{
    ...
    if (killer)
        ...
        else TC_LOG_ERROR("bg.battleground", "BattlegroundRL::HandleKillPlayer: Killer player not found");
    else TC_LOG_ERROR("bg.battleground", "BattlegroundRL::HandleKillPlayer: Victim player not found");
