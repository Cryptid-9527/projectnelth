...
class Group
{
    ...
    public:
        ...
        uint32 GetLayerMask() { return m_layerMask; };
        void SetLayerMask(uint32 newmask) { m_layerMask = newmask; };
        void BroadcastNewLayerMask(bool from_leader = false);
        ...
        void GetMembers(std::list<Player*>& players, bool online);
