...
enum TrinityStrings
{
    ...
    LANG_BG_CARRIERS_VULNERABLE         = 616,
    LANG_BG_CARRIERS_MORE_VULNERABLE    = 617,
    ...
    LANG_BG_EYR_HORDE                    = 844,
    LANG_BG_EYR_NODE_ASSAULTED           = 845,
    LANG_BG_EYR_NODE_FRR                 = 846,
    LANG_BG_EYR_NODE_BET                 = 847,
    LANG_BG_EYR_NODE_DR                  = 848,
    LANG_BG_EYR_NODE_MT                  = 849,
    LANG_BG_EYR_NODE_CLAIMED             = 850,
    LANG_BG_EYR_NODE_DEFENDED            = 851,
    LANG_BG_EYR_A_NEAR_VICTORY           = 858,
    LANG_BG_EYR_H_NEAR_VICTORY           = 859,
