...
#define DEFINE_OPCODE_HANDLER(opcode, status, processing, handler)                                      \
    ...
    DEFINE_OPCODE_HANDLER(CMSG_CANCEL_QUEUED_SPELL,                     STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCancelQueuedSpellOpcode   );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_PET_SPELL_AUTOCAST,                      STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetSpellAutocastOpcode    );//almost never occurs, but rather set action? what?
    ...
    DEFINE_OPCODE_HANDLER(CMSG_SET_PRIMARY_TALENT_TREE,                 STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetPrimaryTreeOpcode      );
    ...
    DEFINE_OPCODE_HANDLER(CMSG_UPDATE_MISSILE_TRAJECTORY,               STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateMissileTrajectory   );       // Wondi: changed from STATUS_UNHANDLED to STATUS_LOGGEDIN (core could not recognize when get obstacle, now can)
    DEFINE_OPCODE_HANDLER(CMSG_UPDATE_PROJECTILE_POSITION,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUpdateProjectilePosition  );      // Wondi: changed from STATUS_UNHANDLED to STATUS_LOGGEDIN (core could not recognize when get obstacle, now can)
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PREP_LUA_SCRIPT,                         STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
    DEFINE_OPCODE_HANDLER(SMSG_SEND_LUA_SCRIPT,                         STATUS_NEVER,       PROCESS_INPLACE,    &WorldSession::Handle_ServerSide               );
    ...
    DEFINE_OPCODE_HANDLER(SMSG_PET_TAME_FAILURE,                        STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::Handle_ServerSide               );
