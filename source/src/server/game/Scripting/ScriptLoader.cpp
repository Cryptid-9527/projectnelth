...
void AddSC_wailing_bosses();                    // Wailing Caverns Bosses
...
void AddCommandScripts()
{
    ...
    AddSC_complaints_commandscript();
...
void AddKalimdorScripts()
{
    ...
    AddSC_wailing_bosses();                 //Wailing cavern bosses
...
{
#ifdef SCRIPTS
    AddSC_npc_challenge_mode();
    AddSC_BackgroundSQLTask();
    AddSC_mythic_rewards();
    AddSC_Skirmish_npc();
    AddSC_solo_queue();
    AddSC_TemplateLoader();
    AddSC_TemplateCommands();
    AddSC_AccountTemplates();
    AddSC_GlobalTemplates();
    AddSC_ArenaRewards();
    AddSC_TournamentScripts();
    Add_SC_Custom_Rates();
    AddSC_SelfFakeMorpher();
