...
class CreatureScript : public UnitScript, public UpdatableScript<Creature>
{
    ...
    public:
        ...
        // Custom
        virtual bool OnGossipHello(Player* /*player*/, Creature* /*creature*/, uint32 /*scriptId*/) { return false; }

        // Called when a player selects a gossip item in the creature's gossip menu.
        virtual bool OnGossipSelect(Player* /*player*/, Creature* /*creature*/, uint32 /*sender*/, uint32 /*action*/) { return false; }

        // Custom
        virtual bool OnGossipSelect(Player* /*player*/, Creature* /*creature*/, uint32 /*sender*/, uint32 /*action*/, uint32 /*scriptId*/) { return false; }
        ...
        // Custom
        virtual bool OnGossipSelectCode(Player* /*player*/, Creature* /*creature*/, uint32 /*sender*/, uint32 /*action*/, const char* /*code*/, uint32 /*scriptId*/) { return false; }
...
class GameObjectScript : public ScriptObject, public UpdatableScript<GameObject>
{
    ...
    public:
        ...
        // Called BEFORE the game object state is changed.
        virtual void BeforeGameObjectStateChanged(GameObject* /*go*/, uint32 /*state*/) { }

        // Called when the game object state is changed.
        virtual void OnGameObjectStateChanged(GameObject* /*go*/, uint32 /*state*/) { }

        // Called AFTER the game object state is changed.
        virtual void AfterGameObjectStateChanged(GameObject* /*go*/, uint32 /*state*/) { }
...
class PlayerScript : public UnitScript
{
    ...
    public:
        ...
        virtual void OnItemEquip(Player* /*player*/, Item* /*pItem*/, bool /*equip*/ ) {}
...
class ScriptMgr
{
    ...
    public: /* ItemScript */
        ...
        void OnGossipSelectCode(Player* player, Item* item, uint32 sender, uint32 action, const char*);

    public: /* CreatureScript */

        bool OnDummyEffect(Unit* caster, uint32 spellId, SpellEffIndex effIndex, Creature* target);
        bool OnGossipHello(Player* player, Creature* creature);
        bool OnGossipHello(Player* player, Creature* creature, uint32 scriptId);
        bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action);
        bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action, uint32 scriptId);
        bool OnGossipSelectCode(Player* player, Creature* creature, uint32 sender, uint32 action, const char* code);
        bool OnGossipSelectCode(Player* player, Creature* creature, uint32 sender, uint32 action, const char* code, uint32 scriptId);
    ...
    public: /* GameObjectScript */
        ...
        void BeforeGameObjectStateChanged(GameObject* go, uint32 state);
        void AfterGameObjectStateChanged(GameObject* go, uint32 state);
    ...
    public: /* PlayerScript */
        ...
        void OnPlayerItemEquipped(Player* player, Item* pItem, bool equip = true);
